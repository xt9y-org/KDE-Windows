...
$tests = @('ShellConfig', 'ShellPolicy', 'WindowModel', 'ApplicationModel', 'PanelLayout', 'TrayModel', 'AudioState', 'SystemState', 'ClipboardModel', 'ShortcutAction', 'WindowSwitcher', 'DesktopModel')
